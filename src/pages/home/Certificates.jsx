          ...
          >
            {[cert1, cert2, cert3, cert4, cert5].map((src, index) => (
              <SwiperSlide key={index}>
                <div className="w-full h-[440px] md:h-[560px] bg-[color:var(--color-accent-muted)] rounded-2xl flex items-center justify-center p-4 md:p-6 shadow-lg shadow-black/10">
                  <img
                    src={src}
